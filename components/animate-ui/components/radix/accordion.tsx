  ...
  return (
    <AccordionHeaderPrimitive className="flex">
      ...
      >
        {children}
        {showArrow && (
          <span className="flex size-6 shrink-0 translate-y-0.5 items-center justify-center rounded-full border border-dashed">
            <ChevronDownIcon className="pointer-events-none size-3.5 text-muted-foreground transition-transform duration-200" />
          </span>
        )}
      </AccordionTriggerPrimitive>
