...
export default function BlogRenderer({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        style: "font-size:17px;line-height:1.85;color:#334155;outline:none;",
      },
    },
  })
  ...
  return (
    <>
      ...
      <style>{`
        .ProseMirror h1 { font-size:2rem; font-weight:800; margin:2rem 0 .75rem; color:#0c1e45; letter-spacing:-.02em; }
        .ProseMirror h2 { font-size:1.6rem; font-weight:700; margin:2rem 0 .75rem; color:#0c1e45; }
        .ProseMirror h3 { font-size:1.3rem; font-weight:700; margin:1.5rem 0 .5rem; color:#0c1e45; }
        .ProseMirror h4,.ProseMirror h5,.ProseMirror h6 { font-size:1.1rem; font-weight:700; margin:1.25rem 0 .5rem; color:#0c1e45; }
        ...
        .ProseMirror pre { background:#0c1e45; color:#e2e8f0; border-radius:10px; padding:1.25rem 1.5rem; margin:1.75rem 0; overflow-x:auto; }
