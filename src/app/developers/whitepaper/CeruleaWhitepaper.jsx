...
<g class="g-p3"><circle cx="612" cy="160" r="22" fill="#2E3148" opacity=".85"/><text x="612" y="156" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">COS</text><text x="612" y="169" text-anchor="middle" font-size="8" fill="#fff">MOS</text><text x="612" y="194" text-anchor="middle" font-size="9" fill="#555">Go · Full sovereignty</text></g>
<g class="g-p4"><circle cx="680" cy="85" r="22" fill="#E6007A" opacity=".85"/><text x="680" y="81" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">POLKA</text><text x="680" y="94" text-anchor="middle" font-size="8" fill="#fff">DOT</text><text x="680" y="119" text-anchor="middle" font-size="9" fill="#555">Rust · Parachain</text></g>
...
<g class="g-p1"><circle cx="125" cy="85" r="22" fill="#E6007A" opacity=".85"/><text x="125" y="81" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">POLKA</text><text x="125" y="94" text-anchor="middle" font-size="8" fill="#fff">DOT</text><text x="125" y="119" text-anchor="middle" font-size="9" fill="#555">Rust · Top-tier</text></g>
<g class="g-p2"><circle cx="196" cy="152" r="22" fill="#2E3148" opacity=".85"/><text x="196" y="148" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">COS</text><text x="196" y="161" text-anchor="middle" font-size="8" fill="#fff">MOS</text><text x="196" y="186" text-anchor="middle" font-size="9" fill="#555">Go · Full SDK</text></g>
...
<g class="g-p1"><circle cx="118" cy="86" r="22" fill="#FF6B35" opacity=".85"/><text x="118" y="82" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">R3</text><text x="118" y="95" text-anchor="middle" font-size="8" fill="#fff">CORDA</text><text x="118" y="120" text-anchor="middle" font-size="9" fill="#555">Permissioned · Finance</text></g>
...
<g class="g-ann"><path d="M178,162 Q408,220 624,302" fill="none" stroke="#1B5E7B" stroke-width="2" stroke-dasharray="8,5" stroke-opacity=".6"/><text x="410" y="215" text-anchor="middle" font-size="10" fill="#1B5E7B" font-weight="700" font-style="italic">CERULEA DUAL-CHAIN: covers both positions</text></g>
...
<g class="g-p2"><circle cx="614" cy="178" r="22" fill="#2E3148" opacity=".85"/><text x="614" y="174" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">COS</text><text x="614" y="187" text-anchor="middle" font-size="8" fill="#fff">MOS</text><text x="614" y="212" text-anchor="middle" font-size="9" fill="#555">Flexible · 6-12 months</text></g>
<g class="g-p3"><circle cx="675" cy="108" r="22" fill="#E6007A" opacity=".85"/><text x="675" y="104" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">POLKA</text><text x="675" y="117" text-anchor="middle" font-size="8" fill="#fff">DOT</text><text x="675" y="142" text-anchor="middle" font-size="9" fill="#555">Flexible · 6-12 months</text></g>
