...
function DCFDiagramContent() {
  ...
  <g class="g-n6">
    <line x1="372" y1="322" x2="298" y2="370" stroke="#3A7CA5" stroke-width="1.5" stroke-dasharray="4,3"/>
  ...
  <g class="g-n7">
    <line x1="354" y1="270" x2="282" y2="270" stroke="#489FB5" stroke-width="1.5" stroke-dasharray="4,3"/>
  ...
  <g class="g-n8">
    <line x1="372" y1="218" x2="298" y2="170" stroke="#489FB5" stroke-width="1.5" stroke-dasharray="4,3"/>
...
<g class="g-p3"><circle cx="638" cy="134" r="22" fill="#2E3148" opacity=".85"/><text x="638" y="130" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">COS</text><text x="638" y="143" text-anchor="middle" font-size="8" fill="#fff">MOS</text><text x="638" y="168" text-anchor="middle" font-size="9" fill="#555">Go · Full sovereignty</text></g>
<g class="g-p4"><circle cx="671" cy="106" r="22" fill="#E6007A" opacity=".85"/><text x="671" y="102" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">POLKA</text><text x="671" y="115" text-anchor="middle" font-size="8" fill="#fff">DOT</text><text x="671" y="140" text-anchor="middle" font-size="9" fill="#555">Rust · Parachain</text></g>
...
<g class="g-p1"><circle cx="146" cy="106" r="22" fill="#E6007A" opacity=".85"/><text x="146" y="102" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">POLKA</text><text x="146" y="115" text-anchor="middle" font-size="8" fill="#fff">DOT</text><text x="146" y="140" text-anchor="middle" font-size="9" fill="#555">Rust · Top-tier</text></g>
<g class="g-p2"><circle cx="179" cy="134" r="22" fill="#2E3148" opacity=".85"/><text x="179" y="130" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">COS</text><text x="179" y="143" text-anchor="middle" font-size="8" fill="#fff">MOS</text><text x="179" y="168" text-anchor="middle" font-size="9" fill="#555">Go · Full SDK</text></g>
...
<g class="g-p1"><circle cx="146" cy="106" r="22" fill="#FF6B35" opacity=".85"/><text x="146" y="102" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">R3</text><text x="146" y="115" text-anchor="middle" font-size="8" fill="#fff">CORDA</text><text x="146" y="140" text-anchor="middle" font-size="9" fill="#555">Permissioned · Finance</text></g>
<g class="g-p2"><circle cx="671" cy="470" r="22" fill="#E6007A" opacity=".85"/><text x="671" y="466" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">POLKA</text><text x="671" y="479" text-anchor="middle" font-size="8" fill="#fff">DOT</text><text x="671" y="504" text-anchor="middle" font-size="9" fill="#555">Permissionless · Dev</text></g>
<g class="g-p3"><circle cx="638" cy="498" r="22" fill="#2E3148" opacity=".85"/><text x="638" y="494" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">COS</text><text x="638" y="507" text-anchor="middle" font-size="8" fill="#fff">MOS</text><text x="638" y="532" text-anchor="middle" font-size="9" fill="#555">Permissionless · Dev</text></g>
...
<g class="g-ann"><path d="M158,134 Q408,200 618,302" fill="none" stroke="#1B5E7B" stroke-width="2" stroke-dasharray="8,5" stroke-opacity=".6"/><text x="410" y="195" text-anchor="middle" font-size="10" fill="#1B5E7B" font-weight="700" font-style="italic">CERULEA DUAL-CHAIN: covers both positions</text></g>
<g class="g-p5"><circle cx="178" cy="134" r="26" fill="#1B5E7B"/><text x="178" y="127" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">CERULEA</text><text x="178" y="140" text-anchor="middle" font-size="8" fill="#AEDBE8">PRIVATE</text><text x="178" y="172" text-anchor="middle" font-size="9" fill="#1B5E7B">Permissioned · Enterprise</text><circle cx="638" cy="302" r="26" fill="#1B5E7B" fill-opacity=".2" stroke="#1B5E7B" stroke-width="2.5"/><text x="638" y="295" text-anchor="middle" font-size="9" font-weight="700" fill="#1B5E7B">CERULEA</text><text x="638" y="308" text-anchor="middle" font-size="8" fill="#1B5E7B">PUBLIC L1</text><text x="638" y="340" text-anchor="middle" font-size="9" fill="#1B5E7B">Permissionless · Both</text></g>
</svg>` }}
      />
    </>
  );
...
<g class="g-p2"><circle cx="638" cy="162" r="22" fill="#2E3148" opacity=".85"/><text x="638" y="158" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">COS</text><text x="638" y="171" text-anchor="middle" font-size="8" fill="#fff">MOS</text><text x="638" y="196" text-anchor="middle" font-size="9" fill="#555">Flexible · 6-12 months</text></g>
<g class="g-p3"><circle cx="671" cy="134" r="22" fill="#E6007A" opacity=".85"/><text x="671" y="130" text-anchor="middle" font-size="9" font-weight="700" fill="#fff">POLKA</text><text x="671" y="143" text-anchor="middle" font-size="8" fill="#fff">DOT</text><text x="671" y="168" text-anchor="middle" font-size="9" fill="#555">Flexible · 6-12 months</text></g>
