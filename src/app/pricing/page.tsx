...
const TIERS = [
  {
    ...
    priceLine: '$40',
    periodLine: '/month',
    description: 'Deploy your application to the Cerulea Public L1, a shared network with validator and RPC infrastructure already live.',
...
const COMPARISON_DATA = [
  {
    ...
    rows: [
      ...
      { feature: 'RPC Access',      pub: 'Shared, 2 nodes',   priv: 'Shared',    pro: '1 dedicated node', ent: 'Custom' },
